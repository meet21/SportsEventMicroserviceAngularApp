...
public class SportsEventMicroserviceApplication {
	...
	Docket swaggerConfiguration() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.cognizant.sportsEventMicroservice"))
				.build()
				.apiInfo(apiInfo());
	}
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Sports_Event API")
				.description("This API can be used to get information of all Sports and Events")
				.version("V1.0")
				.build();
	}
}
